...
<div id="tooplate_wrapper">
    ...
    <div id="tooplate_menu">
        <ul>
			...
			<li><a href="evenements_type.xml"  class="current">Par Catégorie</a></li>
	...
	<h1>La liste des événements de l'année 2020 par catégorie</h1><br/>
    	<xsl:for-each select="evenements/type">
        <div class="col_w960">
...
<p style="padding-left: 15px; padding-top: 15px">Réalisé par :</p>
		<ul>
		<li>Adnane M'barki<a href="mailto:mbarki.adnane98@gmail.com">mbarki.adnane98@gmail.com</a></li>
		<li>Taha Lekhlaikh <a href="mailto:mbarki.charifa@gmail.com">taha00lekhlaikh@gmail.com</a></li>
