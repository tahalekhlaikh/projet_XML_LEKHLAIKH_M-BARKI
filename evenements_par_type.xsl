...
<div id="tooplate_wrapper">
    ...
    <div id="tooplate_menu">
        <ul>
			...
			<li><a href="evenements.xml" class="current"><xsl:value-of select="type/@categorie"/></a></li>
    ...
    <div id="tooplate_main">
    	<h1>La liste de l'événement <xsl:value-of select="type/@categorie"/></h1><br/>
        <div class="col_w960 col_w960_last">
			<div class="col_w600 float_l">
			<xsl:for-each select="type/evenement">
